...
import com.MTGCollectionApp.demo.service.FormService;
...
public class MTGCollectionFormController {

    private final FormService formService;

    @Autowired
    public MTGCollectionFormController(FormService theFormService) {
