...
import com.MTGCollectionApp.demo.service.CardService;
...
public class MTGCollectionRestController {

    private final CardService cardService;

    @Autowired
    public MTGCollectionRestController(CardService theCardService) {
